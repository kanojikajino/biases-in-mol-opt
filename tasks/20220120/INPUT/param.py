...
OfflineTrainDataConstruction_params = {
    'gen_episode_memory_kwargs': {'@n_episode': [2 ** x for x in range(6, 14)],
                                  'remove_last': False,
...
PlotBiasEstimation_params = {
    'x': ('OfflineTrainDataConstruction_params', 'gen_episode_memory_kwargs', 'n_episode'),
    'plot_config_list': [{'col_name': 'mean_train_return_---',
                         ...
                         #{'col_name': 'mean_train_return_-+-',
                         # 'yerr_col_name': 'std_train_return_-+-',
                         # 'plot_kwargs': {'marker': 'x', 'logx': True}},
    ...
    'fig_config': {'xlabel': {'xlabel': r'Training sample size',
                              'fontsize': 16},
                   'ylabel': {'ylabel': 'Performance',
                              'fontsize': 16},
                   'legend': {'labels': ['$J_{\mathrm{PI}}(\hat{G}, \hat{f})$',
                                         #'$J_{\mathrm{PI}}^{-+}$',
                                         #'$J_{\mathrm{PI}}^{+-}$',
                                         #'$J_{\mathrm{DR}}^{--}$',
                                         '$J_{\mathrm{PI}}(\hat{G}, f^{\infty})$',
                                         '$J^\star(\hat{G})$'],
                              'fontsize': 12,
                              'loc': 'upper center',
